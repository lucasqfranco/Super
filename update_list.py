...
SOURCES = [
    ...
    # FUENTES VOD (PELÍCULAS Y SERIES)
...
CATEGORIES = {
    ...
    'NIÑOS': ['disney', 'nick', 'cartoon', 'kids', 'discovery kids', 'junior']
}
...
def main():
    raw_list = []
    seen_urls = set()
    print("Recolectando canales y contenido VOD...")
        ...
        try:
            ...
            for line in lines:
                if line.startswith("#EXTINF"): current_inf = line
                    ...
                    if any(w in name_low for w in CATEGORIES['SERIES']): group = "SERIES"
                    ...
                    is_arg = "ar:" in name_low or "ar |" in name_low or 'country="AR"' in current_inf
    ...
    print(f"Lista final con {len(valid_channels)} elementos.")
